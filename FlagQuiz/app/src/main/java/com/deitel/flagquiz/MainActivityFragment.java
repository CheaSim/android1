...
public class MainActivityFragment extends Fragment {
   ...
   public void add(String time,double zhengquelv) {
      Uri uri = Uri.parse("content://com.deitel.flagquiz.data.MyContentProvider/person");
      ContentResolver resolver =  this.getContext().getContentResolver();

      ContentValues values = new ContentValues();
      values.put("name", time);
      values.put("phone", df.format(zhengquelv));
   ...
   public void resetQuiz() {
      ...
      if(1000 / (double) totalGuesses<100)
         add(str,(1000 / (double) totalGuesses));
